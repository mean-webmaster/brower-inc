...
export const SERVICE_COUNTIES: CountyInfo[] = [
  ...
  },
  {
    ...
    state: "OK",
    description:
      "Serving Alfalfa County with portable restrooms and septic services — from Cherokee to Burlington and the surrounding agricultural communities.",
    cities: ["Cherokee", "Burlington", "Carmen", "Helena"],
    stats: { population: "5,702", area: "881 sq mi", founded: "1907" },
    slug: "alfalfa-county",
  },
  {
    id: "grant",
    ...
    state: "OK",
    description:
      "Brower Inc. delivers portable restrooms and septic services across Grant County, including Medford, Pond Creek, and Wakita.",
    cities: ["Medford", "Pond Creek", "Wakita", "Deer Creek"],
    stats: { population: "4,333", area: "1,003 sq mi", founded: "1893" },
    slug: "grant-county",
  },
  {
    id: "major",
    ...
    state: "OK",
    description:
      "Covering Major County with portable sanitation and septic services — including Fairview, Ames, and the surrounding communities.",
    cities: ["Fairview", "Ames", "Ringwood", "Cleo Springs"],
    stats: { population: "7,629", area: "957 sq mi", founded: "1907" },
    slug: "major-county",
  },
  {
    id: "noble",
    ...
    state: "OK",
    description:
      "Brower Inc. serves Noble County with portable restrooms and septic services — including Perry, Billings, and Morrison.",
    cities: ["Perry", "Billings", "Morrison", "Red Rock"],
    stats: { population: "11,261", area: "741 sq mi", founded: "1893" },
    slug: "noble-county",
  },
  {
    id: "payne",
    ...
    state: "OK",
    description:
      "Home to Oklahoma State University in Stillwater. Brower Inc. provides portable restrooms and septic services for Payne County events, construction, and gameday.",
    cities: ["Stillwater", "Cushing", "Perkins", "Yale"],
    stats: { population: "81,784", area: "697 sq mi", founded: "1890" },
    slug: "payne-county",
  },
  {
    id: "woods",
