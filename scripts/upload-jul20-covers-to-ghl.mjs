// Upload the July 20 2026 blog images (cover + hero for both posts) to the
...
const COVERS = [
  "brower-inc-crew-wont-use-porta-potty-heat-safety-oklahoma-blog-cover-newkirk-ok",
  "brower-inc-crew-wont-use-porta-potty-heat-safety-oklahoma-blog-hero-newkirk-ok",
  "brower-inc-can-my-septic-handle-a-party-oklahoma-blog-cover-newkirk-ok",
  "brower-inc-can-my-septic-handle-a-party-oklahoma-blog-hero-newkirk-ok",
];
